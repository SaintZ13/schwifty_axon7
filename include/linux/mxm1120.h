...
#define M1120_IOCTL_SET_CALIBRATION_POLARITY		_IOW(M1120_IOCTL_BASE, 0x0F,  int)
#define M1120_IOCTL_GET_CALIBRATION_POLARITY		_IOR(M1120_IOCTL_BASE, 0x10,  int*)
/* ********************************************************* */
...
#define STR_MXM1120_PARAMETER "/persist/sensors/mxm1120_threshold_Lower_Upper_value.txt"
...
typedef struct {
	...
	bool				irq_enabled;
	int					calibrated_data;
	int                 calibrated_data_polarity; /* 1 IS 180 Data: N(rawData>0); -1:S(rawData<0) */
	int                 calibrated_HighFlag; /*180, Default:0, calibrated Done:1 */
	int                 calibrated_LowFlag; /*0, Default:0, calibrated Done:1 */
	int					last_data;
	short				thrhigh;
	short				thrlow;
	bool				irq_first;
