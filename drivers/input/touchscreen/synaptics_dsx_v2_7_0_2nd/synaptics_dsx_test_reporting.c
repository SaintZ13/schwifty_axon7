...
static ssize_t concat(test_sysfs, _##propname##_show_2nd)(\
		struct device *dev,\
...
static struct device_attribute dev_attr_##propname =\
		...
		concat(test_sysfs, _##propname##_show_2nd),\
		synaptics_rmi4_store_error);

#define store_prototype(propname)\
static ssize_t concat(test_sysfs, _##propname##_store_2nd)(\
		struct device *dev,\
		struct device_attribute *attr,\
...
static struct device_attribute dev_attr_##propname =\
		...
		concat(test_sysfs, _##propname##_store_2nd));
...
DECLARE_COMPLETION(test_remove_complete_2nd);
...
static ssize_t test_sysfs_num_of_mapped_tx_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%u\n", f54->tx_assigned);
}

static ssize_t test_sysfs_num_of_mapped_rx_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%u\n", f54->rx_assigned);
}

static ssize_t test_sysfs_tx_mapping_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	int cnt;
	int count = 0;
...
static ssize_t test_sysfs_rx_mapping_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	int cnt;
	int count = 0;
...
static ssize_t test_sysfs_num_of_mapped_force_tx_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%u\n", f21->tx_assigned);
}

static ssize_t test_sysfs_num_of_mapped_force_rx_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%u\n", f21->rx_assigned);
}

static ssize_t test_sysfs_force_tx_mapping_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	int cnt;
	int count = 0;
...
static ssize_t test_sysfs_force_rx_mapping_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	int cnt;
	int count = 0;
...
static ssize_t test_sysfs_report_size_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%u\n", f54->report_size);
}

static ssize_t test_sysfs_status_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	int retval;
...
static ssize_t test_sysfs_do_preparation_store_2nd(struct device *dev,
...
static ssize_t test_sysfs_force_cal_store_2nd(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	unsigned long setting;
...
static ssize_t test_sysfs_get_report_store_2nd(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	unsigned char command;
...
static ssize_t test_sysfs_resume_touch_store_2nd(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	unsigned char device_ctrl;
...
static ssize_t test_sysfs_do_afe_calibration_store_2nd(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	unsigned long setting;
...
static ssize_t test_sysfs_report_type_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%u\n", f54->report_type);
}

static ssize_t test_sysfs_report_type_store_2nd(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	unsigned char data;
...
static ssize_t test_sysfs_fifoindex_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	int retval;
	unsigned char data[2];
...
static ssize_t test_sysfs_fifoindex_store_2nd(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	unsigned char data[2];
...
static ssize_t test_sysfs_no_auto_cal_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%u\n", f54->no_auto_cal);
}

static ssize_t test_sysfs_no_auto_cal_store_2nd(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	unsigned char data;
...
static ssize_t test_sysfs_read_report_show_2nd(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	unsigned int ii;
	unsigned int jj;
...
static ssize_t test_sysfs_read_report_store_2nd(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	...
	retval = test_sysfs_report_type_store_2nd(dev, attr, buf, count);
	if (retval < 0)
		goto exit;

	retval = test_sysfs_do_preparation_store_2nd(dev, attr, cmd, 1);
	if (retval < 0)
		goto exit;

	retval = test_sysfs_get_report_store_2nd(dev, attr, cmd, 1);
	if (retval < 0)
		goto exit;
	...
	retval = test_sysfs_resume_touch_store_2nd(dev, attr, cmd, 1);
	if (retval < 0)
		goto exit;
...
static ssize_t synaptics_rmi4_raw_data_config(int report_type)
{
	int retval;
	unsigned char timeout = GET_REPORT_TIMEOUT_S * 10;
	unsigned char timeout_count;
	...
	snprintf(buf, sizeof(buf), "%d", report_type);

	retval = test_sysfs_report_type_store_2nd(NULL, NULL, buf, sizeof(buf));
	if (retval < 0)
		goto exit;

	retval = test_sysfs_do_preparation_store_2nd(NULL, NULL, cmd, 1);
	if (retval < 0)
		goto exit;

	retval = test_sysfs_get_report_store_2nd(NULL, NULL, cmd, 1);
	if (retval < 0)
		goto exit;
	...
	retval = test_sysfs_resume_touch_store_2nd(NULL, NULL, cmd, 1);
	if (retval < 0)
		goto exit;
...
static int synaptics_rawdata_read(struct seq_file *m, void *v)
{
	int retval;
	unsigned int ii;
	unsigned int jj;
	...
	int tx_num = f54->tx_assigned;
	int rx_num = f54->rx_assigned;
	int report_type = F54_RAW_16BIT_IMAGE;

	SYNA_INFO("%s: f54 read raw data start\n", __func__);

	if (!f54 || !f54->rmi4_data) {
		SYNA_ERROR("%s: f54 or syn_ts is null\n", __func__);
		return -EINVAL;
	}

	SYNA_INFO("%s: raw data report_type %d\n", __func__, report_type);

	retval = synaptics_rmi4_raw_data_config(report_type);
	if (retval < 0) {
		SYNA_ERROR("%s: faile to get raw data\n", __func__);
		goto exit;
	}

	if (!f54->report_data) {
		SYNA_ERROR("%s: f54->report_data is null\n", __func__);
		goto exit;
	}
	...
	for (ii = 0; ii < tx_num; ii++) {
		for (jj = 0; jj < (rx_num - 1); jj++) {
			seq_printf(m, "%-4d ", *report_data_16);
			report_data_16++;
		}
		seq_printf(m, "%-4d\n", *report_data_16);
		report_data_16++;
	...
	seq_printf(m, "\n");
exit:
	retval = f54->rmi4_data->reset_device(f54->rmi4_data, false);
	if (retval < 0) {
		SYNA_ERROR("%s: fail to reset device\n", __func__);
	}

	SYNA_INFO("%s: f54 read raw data end\n", __func__);

	return 0;
}

static int synaptics_rawdata_open(struct inode *inode, struct file *file)
{
	return single_open(file, synaptics_rawdata_read, NULL);
}

static const struct file_operations rawdata_read_proc_ops = {
	.open		= synaptics_rawdata_open,
	.read		= seq_read,
	.llseek		= seq_lseek,
	.release	= single_release,
};

static int synaptics_rawdata_test_read(struct seq_file *m, void *v)
{
	int ii;
	int len = 0;
	int retval = 0;
	...
	short *min_rawdata;
	short *report_data_16;
	char *coordinate_test_fail = NULL;
	unsigned int num_fail = 0;
	int type_fail = 0;
	int num_of_tx = f54->tx_assigned;
	int num_of_rx = f54->rx_assigned;
	...
	if (!max_rawdata) {
		SYNA_ERROR("%s: Failed to allocate memory\n", __func__);
		type_fail = -1;
		goto exit;
	}
	...
	coordinate_test_fail = kzalloc(num_of_rx * num_of_tx * sizeof(short), GFP_KERNEL);
	if (!coordinate_test_fail) {
		SYNA_ERROR("%s: Failed to allocate memory\n", __func__);
		type_fail = -1;
		goto exit;
	}

	retval = synaptics_get_max_std_rawdata_2nd(max_rawdata);
	if (retval < 0) {
		SYNA_ERROR("%s: faile to get max std rawdata\n", __func__);
		type_fail = -2;
		goto exit;
	}

	retval = synaptics_get_min_std_rawdata_2nd(min_rawdata);
	if (retval < 0) {
		SYNA_ERROR("%s: failed to get min std rawdata\n", __func__);
		type_fail = -2;
		goto exit;
	}
	...
	retval = synaptics_rmi4_raw_data_config(report_type);
	if (retval < 0) {
		SYNA_ERROR("%s: failed to get raw data\n", __func__);
		type_fail = -1;
		goto exit;
	}
	...
	for (ii = 0; ii < num_of_rx * num_of_tx; ii++) {
		if (*(max_rawdata + ii) < *(report_data_16 + ii)) {
			SYNA_INFO("%s: test fail! index = %d, max_rawdata = %d, *report_data_16 = %d\n",
		...
		if (*(min_rawdata + ii) > *(report_data_16 + ii)) {
			SYNA_INFO("%s: test fail! index = %d, min_rawdata = %d, *report_data_16 = %d\n",
...
exit:
	...
	if (num_fail) {
			seq_printf(m, "%d,%d,%d,%d,%d", 0, type_fail,
				num_of_tx, num_of_rx, num_fail);
	...
	if (num_fail || type_fail)
		SYNA_ERROR("%s: rawdata test fail\n", __func__);
	else
		SYNA_INFO("%s: rawdata test pass\n", __func__);
	...
	if (coordinate_test_fail != NULL) {
		kfree(coordinate_test_fail);
		coordinate_test_fail = NULL;
	}

	return len;
}

static int synaptics_rawdata_test_open(struct inode *inode, struct file *file)
{
	return single_open(file, synaptics_rawdata_test_read, NULL);
}

static const struct file_operations rawdata_test_proc_ops = {
	.owner	= THIS_MODULE,
	.open	= synaptics_rawdata_test_open,
	.read	= seq_read,
	.llseek	= seq_lseek,
	.release	= single_release,
};
...
ts_short_circuit_test_val(struct file *file, char __user *page, size_t size, loff_t *ppos)
{
	...
	if (zte_ts_is_td4322()) {
		SYNA_INFO("%s: ts ic is td4322,return it.\n", __func__);
		test_result = 0;
		goto exit;
	}

	if (*ppos) {
		SYNA_INFO("%s: ppos is not null,return it.\n", __func__);
		test_result = -1;
		goto exit;
	}
...
{
	int retval;
	struct proc_dir_entry *refresh = NULL;

	if (f54) {
		SYNA_INFO("%s: Handle already exists\n",
				__func__);
		return 0;
	}
	...
	f54->rmi4_data->num_of_tx = f54->tx_assigned;
	f54->rmi4_data->num_of_rx = f54->rx_assigned;
	refresh = proc_create("touchscreen/ts_rawdata_read_2nd", 0664,
					NULL, &rawdata_read_proc_ops);
	if (refresh == NULL) {
		SYNA_ERROR("proc_create ts_rawdata_read failed!\n");
	}
	refresh = proc_create("touchscreen/ts_rawdata_test_2nd", 0664,
					NULL, &rawdata_test_proc_ops);
	if (refresh == NULL) {
		SYNA_ERROR("proc_create ts_rawdata_test failed!\n");
	}
	refresh = proc_create("touchscreen/ts_short_circuit_test_2nd", 0664,
					NULL, &short_circuit_test_proc_ops);
	if (refresh == NULL) {
		SYNA_ERROR("proc_create ts_short_circuit_test failed!\n");
	}
...
exit:
	complete(&test_remove_complete_2nd);
...
{
	synaptics_rmi4_new_function_2nd(&test_module, true);
...
{
	synaptics_rmi4_new_function_2nd(&test_module, false);

	wait_for_completion(&test_remove_complete_2nd);
